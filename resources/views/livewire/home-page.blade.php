  ...
  <div class="w-full h-screen bg-gradient-to-r from-blue-200 to-cyan-200 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
        <div>
          <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Start your journey with <span class="text-blue-600">EvoMarket</span></h1>
...
{{-- Brand Section Start --}}
  <section class="py-20">
    ...
    <div class="justify-center max-w-6xl px-4 py-4 mx-auto lg:py-0">
      <div class="grid grid-cols-1 gap-6 lg:grid-cols-4 md:grid-cols-2">
        ...
        <div class="bg-white flex flex-col justify-between items-center rounded-lg shadow-md dark:bg-gray-800" wire:key="{{$brand->id}}" >
          <a href="" class="">
            <img src="{{url('storage', $brand->image)}}" alt="{{$brand->name}}" class="object-cover w-full h-24 rounded-t-lg">
          </a>
          <div class="p-5 text-center">
            <a href="" class="text-sm font-bold tracking-tight text-gray-900 dark:text-gray-300">
              {{$brand->name}}
            </a>
          </div>
        </div>
  ...
  {{-- Customern Reviws Section start --}}
