            ...
            <ul>
              ...
              <li class="mb-4" wire:key='{{$category->id}}'>
                <label for="{{$category->slug}}"  class="flex items-center dark:text-gray-300">
                  <input type="checkbox" id="{{$category->slug}}"  wire:model.live='selected_category' value="{{$category->id}}" class="w-4 h-4 mr-2">
            ...
            <ul>
              ...
              <li class="mb-4" wire:key='{{$brand->id}}'>
                <label for="{{$brand->slug}}" class="flex items-center dark:text-gray-300">
                  <input type="checkbox"  id="{{$brand->slug}}"  wire:model.live='selected_brand' value="{{$brand->id}}"class="w-4 h-4 mr-2">
